...
def compute_tower_hanoi(ring_count):
    ...
    result = []
    pegs = [list(reversed(range(1, ring_count+1)))] + [[] for _ in range(1, NUM_PEGS)]
    compute_tower_hanoi_steps(ring_count, 0, 1, 2)
    return result


if __name__ == '__main__':
    ring_count = 4
    compute_tower_hanoi(ring_count)